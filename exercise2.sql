...
SELECT d.Code, COUNT(*) FROM Employees e JOIN Departments d ON d.Code = e.Department;
...
SELECT e.Name, e.LastName FROM Employees e JOIN Departments d ON d.Code=e.Department WHERE d.Budget > 60.000;
-- 2.13 Select the departments with a budget larger than the average budget of all the departments.
SELECT * FROM Departments HAVING Budget > (SELECT AVG(Budget) FROM Departments);
...
DELETE FROM Employees WHERE e.Department = (SELECT Code FROM Departments WHERE Budget > 60000 );
